...
def sBs_half_round_circuit(N,
    ...
    cirq.append(jqtc.CD(N, alphas[0]), [0, 1], default_simulate_mode="kraus")
    ...
    cirq.append(jqtc.CD(N, alphas[1]), [0, 1], default_simulate_mode="kraus")
    ...
    cirq.append(jqtc.CD(N, alphas[2]), [0, 1], default_simulate_mode="kraus")
